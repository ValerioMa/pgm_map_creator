...
int main(int argc, char* argv[])
{
  if (argc > 4)
  {
    ...
    request.set_minheight(atof(argv[2]));
    request.set_maxheight(atof(argv[3]));
    request.set_resolution(atof(argv[4]));
    request.set_filename(argv[5]);
    ...
    std::cout << "Request: "
              ...
              << " MinHeight: " << request.minheight() << " MaxHeight: " << request.maxheight()
              << " Resolution: " << request.resolution() << " Filename: " << request.filename()
